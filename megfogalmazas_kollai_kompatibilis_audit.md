# Megfogalmazási audit – Kollai-kompatibilis verzió

## Módosított fájl
- `index.html`

## Fő cél
A főoldali döntéshozói szöveg finomítása úgy, hogy a rendszer ne központi irányításként, hanem autonómiát védő, önkéntes közösségi infrastruktúraként legyen értelmezhető.

## Lecserélt kifejezési logika
...
## Nyelvek
A főoldali magyar, angol és német i18n szövegek is frissültek.

## Nem módosított rész
A külön DÖR-aloldalak és a PDF-ek tartalmát ebben a körben nem dolgoztam át teljesen, mert a DÖR-anyagot külön fogod adni.
